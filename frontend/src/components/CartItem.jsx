...
return (
    <section className="max_padd_container pt-28">
            ...
            <tbody>
                {all_products.map((product) => {
                    if (cartItems[product.id] > 0){
                        return<tr key={product.id} className="border-b border-slate-900/20 p-6 text-gray-30 medium-14 text-center">
                            <td className="flexCenter"><img src={product.image} alt="prdctImg" height={43} width={43} className="rounded-lg ring-1 ring-slate-900/5 my-1"/></td>
                            ...
                            <td>
                                <div className="bold-22 pl-14"><TbTrash onClick={()=>removeFromCart(product.id)}/></div>
                            </td>
                        </tr>
                    }
                    return null
        ...
        {/* cart detail */}
        <div className="flex flex-col gap-20 my-16 p-8 md:flex-row rounded-md bg-white w-full maw-w-[666px]">
